                ...
                <div className="container px-4 mx-auto">
                    ...
                    <div className="md:max-w-xl text-center mx-auto mb-12 mt-8">
                        ...
                        <h2 className={`text-4xl md:text-7xl tracking-tighter-xl ${darkMode ? 'text-white' : 'text-black'}`}>
                            {language === 'es' ? 'Nuestra visión, tecnología y equipo.' : 'Our vision, technology and team.'}
                        ...
                        <div className="flex flex-wrap lg:items-center -m-4 lg:-m-12">
                            ...
                            <div className="w-full md:w-1/2 p-4 mt-8 md:mt-0 lg:p-12">
                                ...
                                <h2 className={`mb-6 text-3xl md:text-6xl tracking-tighter ${darkMode ? 'text-white' : 'text-black'}`}>
                                    {language === 'es' ? 'Practicantes con un objetivo claro' : 'Interns with a clear objective'}
                                </h2>
                        ...
                        <div className="w-full md:w-1/2 p-4">
                            <div className="md:max-w-md">
                                ...
                                <h2 className={`mb-8 text-4xl md:text-6xl tracking-tighter-xl ${darkMode ? 'text-white' : 'text-black'}`}>
                                    {language === 'es' ? 'tecnologias y como se hizo' : 'Technologies and how it was made'}
                                </h2>
                                <p className={`mb-8 text-base md:text-lg ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                                    {language === 'es' ? 'En este proyecto se utilizaron estas tecnologias, por el lado del FrontEnd se utilzo el framework de react+vite haciendo que el software fuera un poco mas rapido y para el BackEnd se utilizo python y para la automatizacion Selenium' : 'In this project we used these technologies. On the frontend side we used the React+Vite framework making the software a bit faster, and for the backend we used Python and for automation Selenium'}
                                </p>
                                ...
                                {!isExpandedDocs ? (
                                    ...
                                    <>
                                        <p className={`mb-8 text-base md:text-lg ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
{language === 'es'
  ? 'Primero, se elaboró el cronograma y, con base en este, se inició el desarrollo del proyecto. Se establecieron los objetivos, alcance y requerimientos, seguidos de la creación de bocetos y maquetas de la interfaz. Luego, se implementó el frontend tomando en cuenta los diseños previos. Posteriormente, se definió la arquitectura del sistema y las APIs necesarias. Después, se desarrolló la automatización. A continuación, se implementó el backend en Python, asegurando su correcto funcionamiento. Finalmente, se realizó la integración de la automatización con el backend y este con el frontend, logrando la conexión completa del sistema.'
  : 'First, the project timeline was created, and based on it, development began. Objectives, scope, and requirements were defined, followed by the creation of wireframes and interface mockups. Then, the frontend was implemented according to the initial designs. Next, the system architecture and necessary APIs were defined. After that, the automation was developed. The backend was then implemented in Python, ensuring proper functionality. Finally, the automation was integrated with the backend, and the backend with the frontend, achieving a fully connected system.'
}
