...
# 💾 Guardar con extensión xlsm
    ...
    # Abre Excel y JSON para escribir resultados
        ...
        mapeo = {
            ...
            "Mainframe-Cognitive-Storage HW-Storage TPS-Z Middleware_LCR_1-2-3": "P48",
        }
