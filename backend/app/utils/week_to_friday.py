...
def calcular_forecast(forecast_temp_path= "app/temp/Systems HW - North SSA EPM ISC.xlsm"):
    ...
    combinaciones = [
        ...
        (["Mainframe", "Cognitive"], ["Colombia","Venezuela","LCR"], [1, 2, 3]),
        (["Mainframe"], ["Colombia","Venezuela","LCR"], 1),
        (["Mainframe"], ["Colombia","Venezuela","LCR"], [1, 2]),
        (["Mainframe"], ["Colombia","Venezuela","LCR"], [1, 2, 3]),
        ...
        (["Mainframe", "Cognitive", "Storage HW", "Storage TPS", "Z Middleware"], ["Colombia","Venezuela","LCR"], [1, 2, 3]),
        ...
        (["Mainframe", "Cognitive", "Storage HW", "Storage TPS", "Z Middleware"], "Venezuela", [1, 2, 3]),


        # LCR
        (["Mainframe", "Cognitive"], "LCR", 1),
        (["Mainframe", "Cognitive"], "LCR", [1, 2]),
        (["Mainframe", "Cognitive"], "LCR", [1, 2, 3]),
        (["Mainframe"], "LCR", 1),
        (["Mainframe"], "LCR", [1, 2]),
        (["Mainframe"], "LCR", [1, 2, 3]),
        (["Cognitive"], "LCR", 1),
        ...
        (["Storage HW", "Storage TPS"], "LCR", [1, 2, 3]),
        (["Storage HW"], "LCR", 1),
        (["Storage HW"], "LCR", [1, 2]),
        (["Storage HW"], "LCR", [1, 2, 3]),
        (["Storage TPS"], "LCR", 1),
        (["Storage TPS"], "LCR", [1, 2]),
        (["Storage TPS"], "LCR", [1, 2, 3]),
        (["Z Middleware"], "LCR", 1),
        (["Z Middleware"], "LCR", [1, 2]),
        (["Z Middleware"], "LCR", [1, 2, 3]),
        ...
        (["Mainframe", "Cognitive", "Storage HW", "Storage TPS", "Z Middleware"], "LCR", [1, 2, 3]),
